...
void MaterialPropertiesTableMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  if( command==fAddPropertyCmd )
  {
    ...
    G4cout<<"energyUnit    :"<<energyUnit<<G4endl;
    G4cout<<"valueUnit     :"<<valueUnit<<G4endl;
    G4cout<<"propertyValue :"<<propertyValue<<G4endl;
    G4cout<<"type id       :"<<typeid(StoD(propertyValue)).name()<<G4endl;
    */
    ...
    */
    ...
    //Define new units. They will be added in the units table.
    ...
    new G4UnitDefinition("ScntYield3", "1/keV", "1/Energy", scntYield3);
