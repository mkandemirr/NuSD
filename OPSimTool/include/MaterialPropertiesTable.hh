...
class MaterialPropertiesTable: public G4MaterialPropertiesTable {
  ...
  private:
    void CheckUnitsAndConvertToDimensionedDouble(const G4String& photonUnit, //energy or wavelength 
  ...
  public:
    //This function delegates FileReader class for reading energy/wavelength-value pairs 
    //from the specified file and filling the photonEnergies and propertyValues vectors.
    ...
    //This function delegates FileReader class for only reading energy/wavelength values 
    //from the specified file (first column) and filling the photonEnergies vector. The vector, 
    //propertyValues, is filled with the propertyValue parameter.                    
    void AddProperty(const G4String& key, 
                     const G4String& filePath, 
                     const G4String& photonUnit, //energy or wavelength  
                     const G4String& valueUnit, 
