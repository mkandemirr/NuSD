...
NuSDSweanyMessenger::NuSDSweanyMessenger(NuSDSweanyDetConstruction* det)
...
NuSDSweanyMessenger::~NuSDSweanyMessenger()
{
...
void NuSDSweanyMessenger::SetNewValue(G4UIcommand* command, G4String newValue )
{
